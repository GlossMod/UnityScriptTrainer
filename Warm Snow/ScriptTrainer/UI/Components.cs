...
public static class Components
{
    ...
    public static GameObject AddInputField(string Text, int width, string defaultText, GameObject panel, UnityAction<string> action)
    {
        ...
        uiText.GetComponent<RectTransform>().localPosition = new Vector3(MainWindow.ElementX, MainWindow.ElementY, 0);
        ...
        uiInputField.GetComponent<RectTransform>().localPosition = new Vector3(MainWindow.ElementX, MainWindow.ElementY, 0);
    ...
    public static GameObject AddDropdown(string Text, int width, List<string> options, GameObject panel, UnityAction<int> action)
    {
        ...
        uiDropDown.GetComponent<RectTransform>().localPosition = new Vector3(MainWindow.ElementX, MainWindow.ElementY, 0);
