...
public class MainWindow : MonoBehaviour
{
    ...
    public void CreateUI()
    {
        if (canvas == null)
        {
            ...
            #region[创建标题 和 关闭按钮]
            Components.AddTitle("【犹格索托斯的庭院】内置修改器 By:小莫 1.0.0", background);
            ...
            BasicWindow basicScripts = new BasicWindow(BasicScripts);
            #endregion

            #region[添加物品]
            Components.ResetCoordinates(true, true);

            GameObject itemWindow = UIControls.createUIPanel(uiPanel, "410", "600", null);
            itemWindow.GetComponent<Image>().color = UIControls.HTMLString2Color("#424242FF");
            itemWindow.GetComponent<RectTransform>().anchoredPosition = new Vector2(-70, -20);

            ItemWindow itemScripts = new ItemWindow(itemWindow, ElementX, ElementY);
            ...
            Navigation[] nav = new Navigation[]
            {
                ...
                new Navigation("ItemScripts", "获取物品", itemWindow, false),
